...
import 'package:trollium_wallet_flutter/model/address.dart';
...
import 'package:trollium_wallet_flutter/util/ninja/ninja_node.dart';
...
import 'package:trollium_wallet_flutter/network/model/request/fcm_update_request.dart';
...
import 'package:trollium_wallet_flutter/util/nanoutil.dart';
...
class StateContainerState extends State<StateContainer> {
  ...
  AvailableBlockExplorer curBlockExplorer =
      AvailableBlockExplorer(AvailableBlockExplorerEnum.TROLLAREXPLORER);
  BaseTheme curTheme = TrolliumTheme();

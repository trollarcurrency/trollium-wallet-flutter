...
import 'package:trollium_wallet_flutter/ui/util/exceptions.dart';
...
class UIUtil {
 ...
 static StreamSubscription<dynamic> _lockDisableSub;
  ...
  static String getNatriconURL(String address, String nonce) {
    ...
    return "https://natricon.invalid/api/v1/nano?svc=natrium&outline=true&outlineColor=white&address=$address$adjustedNonce";
  }
}

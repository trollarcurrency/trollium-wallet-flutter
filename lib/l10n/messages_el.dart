...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Καλωσήρθατε στο Trollium. Μόλις λάβετε TROLLAR, οι συναλλαγές θα εμφανιστούν ως εξής:"),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("Η αποσύνδεση θα διαγράψει το seed σας και όλα τα δεδομένα σχετικά με το Trollium από αυτή τη συσκευή. Εάν δεν έχετε δημιουργήσει αντίγραφο ασφαλείας του seed σας, δεν θα έχετε ποτέ ξανά πρόσβαση στα χρήματά σας."),
    ...
    "notificationBody" : MessageLookupByLibrary.simpleMessage("Ανοίξτε το Trollium για να δείτε αυτή τη συναλλαγή."),
    "notificationHeaderSupplement" : MessageLookupByLibrary.simpleMessage("Πατήστε για να ανοίξετε"),
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("Λήφθηκαν %1 TROLLAR"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("Να σταλθούν %1 Trollar?"),
    ...
    "shareKalium" : MessageLookupByLibrary.simpleMessage("Κοινοποιήστε το Trollium"),
    "shareKaliumText" : MessageLookupByLibrary.simpleMessage("Δοκιμάστε το Trollium! Το καλύτερο πορτοφόλι για TROLLAR σε κινητά τηλέφωνα!"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("Καλωσήρθατε στο Trollium. Για να συνεχίσετε, μπορείτε να δημιουργήσετε ένα νέο πορτοφόλι ή να εισάγετε ένα υπάρχον."),

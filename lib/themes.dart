...
class TrolliumTheme extends BaseTheme {
  ...
  static const yellow = Color(0xFFFFFFFF);
  ...
  AppIconEnum appIcon = AppIconEnum.TROLLIUM;
}
...
enum AppIconEnum { TROLLIUM, TITANIUM, INDIUM, NEPTUNIUM, THORIUM }
class AppIcon {
